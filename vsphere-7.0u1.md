...
# vCenter Server 7.0 Update 1 (Build 15952498) Events Events
...
| vsan.health.test.cloudhealth.event | EventEx | vSAN online health check |
...
| vsan.health.test.cluster.event | EventEx | Cluster health |
...
| vsan.health.test.cluster.unsupportedadvparameters.event | EventEx | Advanced vSAN configuration supported |
...
| vsan.health.test.data.event | EventEx | Data health |
...
| vsan.health.test.diagnostics.pnic.rxcrcerr.event | EventEx | pNic CRC Error |
| vsan.health.test.diagnostics.pnic.txcarerr.event | EventEx | pNic Carrier Error |
| vsan.health.test.diagnostics.tcpip.tcptxrexmitrate.event | EventEx | TCP/IP Health |
...
| vsan.health.test.hcl.event | EventEx | vSAN HCL health |
...
| vsan.health.test.hcl.vendortoolpresence.event | EventEx | Controller utility is installed on host |
| vsan.health.test.iscsi.event | EventEx | iSCSI target service |
...
| vsan.health.test.limits.diskspace.event | EventEx | Checks the vSAN cluster disk space utilization |
| vsan.health.test.limits.event | EventEx | Limits health |
...
| vsan.health.test.network.event | EventEx | Network health |
...
| vsan.health.test.perfsvc.event | EventEx | vSAN Performance Service health |
...
| vsan.health.test.physicaldisks.event | EventEx | Physical disk health |
...
| vsan.health.test.stretchedcluster.event | EventEx | Stretched cluster health |
...
| vsan.health.test.vum.event | EventEx | vSAN Build Recommendation Engine |
