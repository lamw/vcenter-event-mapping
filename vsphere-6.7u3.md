...
| VmDeployFailedEvent | Standard | Cannot deploy VM |
...
| VmRelocateFailedEvent | Standard | Cannot relocate VM |
...
| vsan.health.test.cluster.coredumpartitionsize.event | EventEx | Coredump partition size check |
...
| vsan.health.test.cluster.healtheaminstall.event | EventEx | Checks if all the hosts in the vSAN cluster have the vSAN Health Service installed. |
| vsan.health.test.cluster.healthversion.event | EventEx | Checks the vSAN health VIB version in all of hosts in a vSAN cluster |
...
| vsan.health.test.cluster.physdiskdedupconfig.event | EventEx | Space efficiency configuration consistency |
| vsan.health.test.cluster.physdiskdedupusage.event | EventEx | Space efficiency usage health |
...
| vsan.health.test.data.vmhealth.event | EventEx | Checks the health status of all vSAN VMs |
| vsan.health.test.dataprotection.archivalaccessibility.event | EventEx | Checks the vSAN data protection archival target accessibility in all of the hosts in a vSAN cluster |
| vsan.health.test.dataprotection.dataprotectionversion.event | EventEx | Checks the vSAN data protection service version in all of the hosts in a vSAN cluster |
| vsan.health.test.dataprotection.datastoreusage.event | EventEx | Checks the vSAN datastore usage in the cluster to determine if data protection should continue or not |
| vsan.health.test.dataprotection.dpcfgsync.event | EventEx | Checks if all of the hosts in a vSAN cluster have consistent data protection configuration options. |
| vsan.health.test.dataprotection.dpdliveness.event | EventEx | Checks the data protection daemon liveness |
| vsan.health.test.dataprotection.event | EventEx | Data protection health |
| vsan.health.test.dataprotection.objectdphealth.event | EventEx | Checks the data protection health status of all vSAN objects |
...
| vsan.health.test.hcl.firmwareproviderhealth.event | EventEx | Check configuration issues for 'Firmware provider health' |
...
| vsan.health.test.hcl.pnicdriver.event | EventEx | Checks if the network adapter driver is VMware certified. |
| vsan.health.test.hcl.pnicfirmware.event | EventEx | Checks if the network adapter firmware is VMware certified. |
| vsan.health.test.hcl.pnichcl.event | EventEx | Network adapter is VMware certified |
| vsan.health.test.hcl.pniconhcl.event | EventEx | Checks if the network adapter is compatible with the VMware Compatibility Guide |
| vsan.health.test.hcl.pnicreleasesupport.event | EventEx | Displays information about whether there is any driver supported for a given network adapter in the release of ESXi installed. |
...
| vsan.health.test.perfsvc.masterexist.event | EventEx | vSAN Performance Service stats master election |
